...
export const getGroups = () => async (dispatch) => {
     try {
       const response = await axios.get('/api/messenger/get-groups');
       dispatch({
   ...
   export const createGroup = (groupData) => async (dispatch) => {
     try {
       const response = await axios.post('/api/messenger/create-group', groupData);
       dispatch({
   ...
   export const getGroupMessages = (groupId) => async (dispatch) => {
     try {
       const response = await axios.get(`/api/messenger/get-group-messages/${groupId}`);
       dispatch({
   ...
   export const sendGroupMessage = (data) => async (dispatch) => {
     try {
       const response = await axios.post('/api/messenger/send-group-message', data);
       dispatch({
   ...
   export const sendGroupImageMessage = (data) => async (dispatch) => {
     try {
       const response = await axios.post('/api/messenger/send-group-image-message', data);
       dispatch({
         type: 'SEND_GROUP_MESSAGE_SUCCESS',
         payload: {
           message: response.data.message
...
export const getChatbotMessages = () => {
  return async (dispatch) => {
    try {
      const response = await axios.get('/api/messenger/chatbot/get-history');
      dispatch({
...
export const sendChatbotMessage = (message) => {
  return async (dispatch) => {
    try {
      const response = await axios.post('/api/messenger/chatbot/send-message', { message });
      dispatch({
...
export const clearChatbotConversation = () => {
  return async (dispatch) => {
    try {
      const response = await axios.post('/api/messenger/chatbot/clear-conversation');
      dispatch({
